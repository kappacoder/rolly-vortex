...
namespace Febucci.UI.Core
{
    ...
    internal class AppearanceDefaultValues
    {
        ...
        public PresetAppearanceValues[] presets = new PresetAppearanceValues[0];
    ...
    public class BehaviorDefaultValues
    {
        ...
        [SerializeField, Header("Preset Effects")]
        public PresetBehaviorValues[] presets = new PresetBehaviorValues[0];
