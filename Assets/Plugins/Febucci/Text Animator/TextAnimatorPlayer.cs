...
namespace Febucci.UI
{
    ...
    public class TextAnimatorPlayer : Core.TAnimPlayerBase
    {
        ...
        [SerializeField] [Core.CharsDisplayTime] [Tooltip("Wait time for normal letters")] float waitForNormalChars = .03f;
        [SerializeField] [Core.CharsDisplayTime] [Tooltip("Wait time for ! ? .")] float waitLong = .6f;
        [SerializeField] [Core.CharsDisplayTime] [Tooltip("Wait time for ; : ) - ,")] float waitMiddle = .2f;
        ...
        internal override float WaitTimeOf(char character)
        {
        ...
        internal override IEnumerator WaitInput()
        {
